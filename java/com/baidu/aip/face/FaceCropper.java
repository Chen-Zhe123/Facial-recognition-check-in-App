...
//
//        int left = points[2];
//        int top_bar = points[3];
//        int right = points[6];
//        int bottom = points[7];
//
//        int width = right - left;
//        int height = bottom - top_bar;
//
//        width = width * 3 / 2;
//        height = height * 2;
//        //
//        left = faceInfo.mCenter_x - width / 2;
//        top_bar = faceInfo.mCenter_y - height / 2;
//
//        height = height * 4 / 5;
//        //
//        left = Math.max(left, 0);
//        top_bar = Math.max(top_bar, 0);
//
//        Rect region = new Rect(left, top_bar, left + width, top_bar + height);
