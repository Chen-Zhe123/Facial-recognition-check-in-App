...
import com.baidu.aip.faceUtils.ArgbPool;
import com.baidu.aip.faceUtils.OnFrameAvailableListener;
...
//        }
        ...
        if (useDetect) {
            ...
            // if (faces!=null){
            //     // Log.group_manager1("faceMulti",faces.length+"");
            // }

            // Log.group_manager1("wtf", value + " process->" + (System.currentTimeMillis() - starttime));
