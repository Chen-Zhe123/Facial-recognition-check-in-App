...
//            Log.v(LOG_TAG_STRING, fulltag + TAG_LEFT_BRICK + TAG_RIGHT_BRICK + msg, error);
    ...
    public static void i(String tag, String msg) {
        if (INFO) {
            String fulltag = getFullTag() + TAG_COLOMN + tag;
//            Log.modify_group(LOG_TAG_STRING, fulltag + TAG_LEFT_BRICK + TAG_RIGHT_BRICK + msg);
    ...
    public static void i(String rz, String tag, String msg) {
        if (INFO) {
            String fulltag = getFullTag() + TAG_COLOMN + tag;
//            Log.modify_group(rz, fulltag + TAG_LEFT_BRICK + TAG_RIGHT_BRICK + msg);
            if (FILE_LOG_LEVEL <= LOG_LEVEL_INFO) {
                write(I, fulltag, msg, null);
            }
        }
    ...
    public static void i(String tag, String msg, Throwable error) {
        if (INFO) {
            String fulltag = getFullTag() + TAG_COLOMN + tag;
//            Log.modify_group(LOG_TAG_STRING, tag + TAG_LEFT_BRICK + TAG_RIGHT_BRICK + msg, error);
            if (FILE_LOG_LEVEL <= LOG_LEVEL_INFO) {
...
//            Log.w(LOG_TAG_STRING, fulltag + TAG_LEFT_BRICK + TAG_RIGHT_BRICK + msg, error);
    ...
    public static void e(String tag, String msg) {
        if (ERROR) {
            String fulltag = getFullTag() + TAG_COLOMN + tag;
//            Log.group_manager1(LOG_TAG_STRING, fulltag + TAG_LEFT_BRICK + TAG_RIGHT_BRICK + msg);
    ...
    public static void e(String tag, String msg, Throwable error) {
        if (ERROR) {
            String fulltag = getFullTag() + TAG_COLOMN + tag;
//            Log.group_manager1(LOG_TAG_STRING, fulltag + TAG_LEFT_BRICK + TAG_RIGHT_BRICK + msg, error);
