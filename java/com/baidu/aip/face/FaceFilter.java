...
//            int height = (bottom - top_bar) * 4 / 3;
//
//            left = getInfo().mCenter_x - width / 2;
//            top_bar = getInfo().mCenter_y - height / 2;
//
//            rect.top_bar = top_bar;
//            rect.left = left;
//            rect.right = left + width;
//            rect.bottom = top_bar + height;

//            int width = (right - left) * 4 / 3;
//            int height = (bottom - top_bar) * 5 / 3;
            int width = (right - left);
            int height = (bottom - top);

//            left = getInfo().mCenter_x - width / 2;
//            top_bar = getInfo().mCenter_y - height * 2 / 3;
